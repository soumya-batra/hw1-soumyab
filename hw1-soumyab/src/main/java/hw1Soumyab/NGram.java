...
public class NGram extends Annotation {
  ...
  /** getter for source - gets Annotator details that annotated the N-Gram sequence
   * @generated */
  public Annotator getSource() {
    if (NGram_Type.featOkTst && ((NGram_Type)jcasType).casFeat_source == null)
      jcasType.jcas.throwFeatMissing("source", "hw1Soumyab.NGram");
    return (Annotator)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((NGram_Type)jcasType).casFeatCode_source)));}
    
  /** setter for source - sets Annotator details that annotated the N-Gram sequence 
   * @generated */
  public void setSource(Annotator v) {
    if (NGram_Type.featOkTst && ((NGram_Type)jcasType).casFeat_source == null)
      jcasType.jcas.throwFeatMissing("source", "hw1Soumyab.NGram");
    jcasType.ll_cas.ll_setRefValue(addr, ((NGram_Type)jcasType).casFeatCode_source, jcasType.ll_cas.ll_getFSRef(v));}    
   
    
  //*--------------*
  //* Feature: elements

  /** getter for elements - gets List of all tokens in the N-Gram sequence
   * @generated */
  public FSArray getElements() {
    if (NGram_Type.featOkTst && ((NGram_Type)jcasType).casFeat_elements == null)
      jcasType.jcas.throwFeatMissing("elements", "hw1Soumyab.NGram");
  ...
  /** setter for elements - sets List of all tokens in the N-Gram sequence 
   * @generated */
  ...
  /** indexed getter for elements - gets an indexed value - List of all tokens in the N-Gram sequence
   * @generated */
  ...
  /** indexed setter for elements - sets an indexed value - List of all tokens in the N-Gram sequence
   * @generated */
